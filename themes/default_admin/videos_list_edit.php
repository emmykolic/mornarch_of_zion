        ...
        <div class="shadow card p-5">
            ...
            <input type="hidden" name="vid" value="<?=$single['vid']?>">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?=$single['name_of_video']?>" name="name_of_video" required>
                </div>
                <div class="mb-3">
                    <label for="">Add Description For The Video <span class="text-danger">*</span></label>
                    <textarea class="form-control" name="video_description" id="editor1" cols="30" rows="10"><?=$single['video_description']?></textarea>
                </div>

                <div class="mb-3">
                    <label for="tag-input">Add Tags For The Video <span class="text-danger">*</span></label>
                    <input type="text" id="tag-input" class="form-control" value="<?=$single['tag_video']?>">
                ...
                <div class="mb-3 input-group">
                    ...
                    <input type="text" name="source" value="<?=$single['source']?>" class="form-control">
                </div>
