...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Mood/</span> Add</h4>
            ...
            <div class="col-md-8 offset-md-2 col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Add Mood</h5>
                    </div>
                    <div class="card-body">
                        <form action="<?=BURL?>mood/action" method="post">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Mood Name" aria-label="Enter Mood Name" aria-describedby="Mood Name" name="mood_name" id="moodName" required />
                                </div>
                            </div>
                            <div class="mb-3">
