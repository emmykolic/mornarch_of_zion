          ...
          <?php if ($this->auth->user->type == 9) : ?>
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="<?= BURL ?>interface_edit" class="menu-link">
                    <div data-i18n="Blank">Interface Description Edit.</div>
                  </a>
                </li>
              </ul>
            </li>
          ...
          <?php if ($this->auth->user->type >= 5) : ?>
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    <a href="<?= BURL ?>payments/adverts" class="menu-link">
                      <div data-i18n="Container">Advert Mgt.</div>
                    </a>
                  </li>

                  <li class="menu-item">
                    <a href="<?= BURL ?>payments/make_payments" class="menu-link">
