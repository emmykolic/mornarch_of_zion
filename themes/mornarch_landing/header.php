...
<body>
    ...
    <?php if (isset($is_landing)) : ?>
        <nav class="navbar navbar-expand-lg navbar-light sticky-top bg-white ftco-navbar-light" id="ftco-navbar">
        <?php else : ?>


            <nav class="navbar navbar-expand-lg navbar-light ftco_navbar mt-0 navbar-dark shadow bg-dark " id="ftco-navbar">
                <?php endif; ?>
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" id="dropdownMenu2" data-toggle="dropdown">More</a>
                            ...
                            <?php if (isset($this->auth->uid)) : ?>
                                <li class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" id="dropdownMenuUser" data-toggle="dropdown">
                            ...
                            <?php else : ?>
                                <li class="nav-item"><a href="<?= BURL ?>signup" class="text-white p-2 nav-link">Login/Register</a></li>
                            <?php endif; ?>

                            <li class="nav-item m-2">
                                <a class="search"><span class="fa fa-search" id="search"></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <!-- END nav -->
             <!-- SEARCH DROPDOWN -->
            <!-- <div id="search_dropdown" class="search-dropdown bg-white shadow p-3 w-100" 
                style="display:none; position:absolute; top:100%; left:0; z-index:9999;">
                <form action="<?= BURL ?>search" method="GET" class="d-flex">
                    <input type="text" name="q" id="search_input" 
                        class="form-control" 
                        placeholder="Search Here..." required>
                    <button type="submit" class="btn btn-danger ml-2">Search</button>
                    <span class="fa fa-times ml-3 mt-2" id="close_search" 
                        style="cursor:pointer; font-size:20px;"></span>
                </form>
            </div> -->

            <!-- Search Input Box -->
            <div class="search-input-box position-relative" id="search_input_box">
                <form class="d-flex justify-content-between search-form">
