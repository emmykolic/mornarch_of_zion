...
<head>
    ...
    <title><?=$this->setting->site_name;?> | SignUp</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Please enter credentials to sign-up to your account</p>

                        <form id="formAuthentication" class="mb-3" action="<?= BURL ?>signup/action" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" name="<?= $this->token; ?>">Sign up</button>
                            </div>
                        </form>
