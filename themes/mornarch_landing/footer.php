        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget">
                    <a href="#" class="logo"><img src="<?= BURL ?>assets/<?= $this->setting->site_logo; ?>" height="50"></a><br><br>
                    <p><strong><?=$this->setting->site_name?></strong> <br>is a divine platform dedicated to promoting Gospel music, sharing inspiring lyrics, and spreading the message of Christ through uplifting sounds and faith-filled content.</p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?= BURL ?>index/privacyPolicy" class="py-2 d-block">Privacy &amp; Cookies Policy</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
